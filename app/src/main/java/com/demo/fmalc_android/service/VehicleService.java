...
public interface VehicleService {
    ...
    Call<AlertRequestDTO> sendRequestWhileRunning(@Body AlertRequestDTO alertRequest
            , @Header("Authorization") String auth);

//    @Headers({ "Content-Type: application/json;charset=UTF-8"})
    @GET("api/v1.0/vehicles/detailVehicle/{id}")
    Call<VehicleDetail> getDetailVehicle(@Path("id") int id);
